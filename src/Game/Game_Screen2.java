...
public class Game_Screen2 extends JFrame {
	...
	int userHP = 10, userDice = 15, userDefense = 0, computerHP = 10, computerDice = 15, computerDefense = 0,
			maxHP = 10;
	int[] dice = new int[5];
	...
	public Game_Screen2() {
		 ...
		 * userResult1.setBounds(29, 11, 135, 15); JLabel userResult2 = new
		 * JLabel("주사위2"); userResult2.setHorizontalAlignment(SwingConstants.CENTER);
		 * userResult2.setBounds(29, 36, 135, 15); JLabel userResult3 = new
		 * JLabel("주사위3"); userResult3.setHorizontalAlignment(SwingConstants.CENTER);
		 * userResult3.setBounds(29, 61, 135, 15); JLabel userResult4 = new
		 * JLabel("주사위4"); userResult4.setHorizontalAlignment(SwingConstants.CENTER);
		 * userResult4.setBounds(29, 86, 135, 15); JLabel userResult5 = new
		 * JLabel("주사위5"); userResult5.setHorizontalAlignment(SwingConstants.CENTER);
		 * userResult5.setBounds(29, 111, 135, 15);
		 * 
		 * jp10.setBackground(Color.WHITE); jp10.setLayout(null); jp10.add(userResult1);
		 * jp10.add(userResult2); jp10.add(userResult3); jp10.add(userResult4);
		 * jp10.add(userResult5);
		 * 
		 * // 주사위 결과 출력 comResult1~5 JLabel comResult1 = new JLabel("주사위1");
		 * comResult1.setHorizontalAlignment(SwingConstants.CENTER);
		 * comResult1.setBounds(30, 10, 140, 15); JLabel comResult2 = new
		 * JLabel("주사위2"); comResult2.setHorizontalAlignment(SwingConstants.CENTER);
		 * comResult2.setBounds(30, 35, 140, 15); JLabel comResult3 = new
		 * JLabel("주사위3"); comResult3.setHorizontalAlignment(SwingConstants.CENTER);
		 * comResult3.setBounds(30, 60, 140, 15); JLabel comResult4 = new
		 * JLabel("주사위4"); comResult4.setHorizontalAlignment(SwingConstants.CENTER);
		 * comResult4.setBounds(30, 85, 140, 15); JLabel comResult5 = new
		 * JLabel("주사위5"); comResult5.setHorizontalAlignment(SwingConstants.CENTER);
		 * comResult5.setBounds(30, 110, 140, 15); JPanel jp9 = new JPanel();
		 * jp9.setBackground(Color.LIGHT_GRAY); jp9.setLayout(null);
