...
public class Game_Screen1 extends JFrame {
	...
	public Game_Screen1() { 
		...
		jp1.add(comDiceTitle); jp2.add(comDiceX); jp2.add(comDice);
		...
		JPanel jp4 = new JPanel(); jp4.setLayout(null);
		...
		JPanel jp6 = new JPanel(); jp6.setLayout(null);
		jp5.add(userDiceTitle); jp6.add(userDice); jp6.add(userDiceX);
		...
		JPanel jp8 = new JPanel(); jp8.setLayout(null);
		JPanel jp7 = new JPanel(new FlowLayout(FlowLayout.CENTER));
		jp7.add(userDefense); jp8.add(userMaxHP); jp8.add(userHP);
		...
		getContentPane().add(throwDice); getContentPane().add(stopGame);
		...
		JPanel comResult = new JPanel(); comResult.setLayout(null);
		comResult.setBackground(Color.LIGHT_GRAY);		
		comResult.add(comResult1); comResult.add(comResult2); comResult.add(comResult3);
		comResult.add(comResult4); comResult.add(comResult5);
		
		JPanel userResult = new JPanel(); userResult.setLayout(null);
		userResult.setBackground(Color.WHITE);		
		userResult.add(userResult1); userResult.add(userResult2); userResult.add(userResult3);
		userResult.add(userResult4); userResult.add(userResult5);
		
		getContentPane().add(comResult); getContentPane().add(userResult);
...
//		}
	...
	void userRoll() {	// 유저 주사위 굴리기
		...
		for (int i = 0; i < diceValue.length; i++) {
			diceValue[i] = (int) (Math.random() * 4 + 1);
	...
	void userRoll4() {
		...
		for (int i = 0; i < diceValue.length; i++) {
			diceValue[i] = (int) (Math.random() * userDiceData + 1);
	...
	void comRoll4() {
		...
		for (int i = 0; i < diceValue.length; i++) {
			diceValue[i] = (int) (Math.random() * comDiceData + 1);
